...
base_interfaces_demo__msg__Ohom__create()
{
  ...
  base_interfaces_demo__msg__Ohom * msg = (base_interfaces_demo__msg__Ohom *)allocator.allocate(sizeof(base_interfaces_demo__msg__Ohom), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(base_interfaces_demo__msg__Ohom));
  bool success = base_interfaces_demo__msg__Ohom__init(msg);
  if (!success) {
...
base_interfaces_demo__msg__Ohom__destroy(base_interfaces_demo__msg__Ohom * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    base_interfaces_demo__msg__Ohom__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
base_interfaces_demo__msg__Ohom__Sequence__init(base_interfaces_demo__msg__Ohom__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  base_interfaces_demo__msg__Ohom * data = NULL;

  if (size) {
    data = (base_interfaces_demo__msg__Ohom *)allocator.zero_allocate(size, sizeof(base_interfaces_demo__msg__Ohom), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = base_interfaces_demo__msg__Ohom__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        base_interfaces_demo__msg__Ohom__fini(&data[i - 1]);
      }
...
base_interfaces_demo__msg__Ohom__Sequence__fini(base_interfaces_demo__msg__Ohom__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      base_interfaces_demo__msg__Ohom__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  base_interfaces_demo__msg__Ohom__Sequence * array = (base_interfaces_demo__msg__Ohom__Sequence *)allocator.allocate(sizeof(base_interfaces_demo__msg__Ohom__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = base_interfaces_demo__msg__Ohom__Sequence__init(array, size);
  if (!success) {
...
base_interfaces_demo__msg__Ohom__Sequence__destroy(base_interfaces_demo__msg__Ohom__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    base_interfaces_demo__msg__Ohom__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
base_interfaces_demo__msg__Ohom__Sequence__are_equal(const base_interfaces_demo__msg__Ohom__Sequence * lhs, const base_interfaces_demo__msg__Ohom__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!base_interfaces_demo__msg__Ohom__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  base_interfaces_demo__msg__Ohom__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(base_interfaces_demo__msg__Ohom);
    base_interfaces_demo__msg__Ohom * data =
      (base_interfaces_demo__msg__Ohom *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!base_interfaces_demo__msg__Ohom__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          base_interfaces_demo__msg__Ohom__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!base_interfaces_demo__msg__Ohom__copy(
