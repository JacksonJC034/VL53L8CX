...
#include "base_interfaces_demo/msg/detail/test__rosidl_typesupport_fastrtps_c.h"
...
using _Test__ros_msg_type = base_interfaces_demo__msg__Test;
...
size_t get_serialized_size_base_interfaces_demo__msg__Test(
  const void * untyped_ros_message,
...
static uint32_t _Test__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_base_interfaces_demo__msg__Test(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_base_interfaces_demo
size_t max_serialized_size_base_interfaces_demo__msg__Test(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_base_interfaces_demo__msg__Test(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, base_interfaces_demo, msg, Test)() {
