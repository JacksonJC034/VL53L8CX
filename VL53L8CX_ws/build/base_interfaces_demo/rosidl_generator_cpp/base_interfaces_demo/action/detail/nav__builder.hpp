...
class Init_Nav_Result_success
{
public:
  explicit Init_Nav_Result_success(::base_interfaces_demo::action::Nav_Result & msg)
  : msg_(msg)
  {}
  ::base_interfaces_demo::action::Nav_Result success(::base_interfaces_demo::action::Nav_Result::_success_type arg)
  {
...
class Init_Nav_Result_current_theta
{
public:
  explicit Init_Nav_Result_current_theta(::base_interfaces_demo::action::Nav_Result & msg)
  : msg_(msg)
  {}
  Init_Nav_Result_success current_theta(::base_interfaces_demo::action::Nav_Result::_current_theta_type arg)
  {
    msg_.current_theta = std::move(arg);
    return Init_Nav_Result_success(msg_);
  }
...
class Init_Nav_Result_current_y
{
public:
  explicit Init_Nav_Result_current_y(::base_interfaces_demo::action::Nav_Result & msg)
  : msg_(msg)
  {}
  Init_Nav_Result_current_theta current_y(::base_interfaces_demo::action::Nav_Result::_current_y_type arg)
  {
    msg_.current_y = std::move(arg);
    return Init_Nav_Result_current_theta(msg_);
  }
...
class Init_Nav_Result_current_x
{
public:
  Init_Nav_Result_current_x()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Nav_Result_current_y current_x(::base_interfaces_demo::action::Nav_Result::_current_x_type arg)
  {
    msg_.current_x = std::move(arg);
    return Init_Nav_Result_current_y(msg_);
  }
...
{
  return base_interfaces_demo::action::builder::Init_Nav_Result_current_x();
}
