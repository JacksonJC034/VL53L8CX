...
#include <stddef.h>
#include "base_interfaces_demo/msg/detail/test__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  base_interfaces_demo__msg__Test__init(message_memory);
}

void Test__rosidl_typesupport_introspection_c__Test_fini_function(void * message_memory)
{
  base_interfaces_demo__msg__Test__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Test__rosidl_typesupport_introspection_c__Test_message_member_array[1] = {
  {
    ...
    offsetof(base_interfaces_demo__msg__Test, test),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Test__rosidl_typesupport_introspection_c__Test_message_members = {
  ...
  "Test",  // message name
  1,  // number of fields
  sizeof(base_interfaces_demo__msg__Test),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, base_interfaces_demo, msg, Test)() {
