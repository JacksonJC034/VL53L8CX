...
#include <stddef.h>
#include "base_interfaces_demo/msg/detail/color_info__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  base_interfaces_demo__msg__ColorInfo__init(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember ColorInfo__rosidl_typesupport_introspection_c__ColorInfo_message_member_array[1] = {
  {
    ...
    offsetof(base_interfaces_demo__msg__ColorInfo, color_type),  // bytes offset in struct
    NULL,  // default value
