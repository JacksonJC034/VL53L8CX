...
#include "base_interfaces_demo/msg/detail/lift_control__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const base_interfaces_demo::msg::LiftControl & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  base_interfaces_demo::msg::LiftControl & ros_message)
{
  // Member: error_code
  cdr >> ros_message.error_code;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_base_interfaces_demo
max_serialized_size_LiftControl(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const base_interfaces_demo::msg::LiftControl *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<base_interfaces_demo::msg::LiftControl *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LiftControl__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const base_interfaces_demo::msg::LiftControl *>(
...
{
  return max_serialized_size_LiftControl(full_bounded, 0);
}

static message_type_support_callbacks_t _LiftControl__callbacks = {
...
static rosidl_message_type_support_t _LiftControl__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LiftControl__callbacks,
...
{
  return &base_interfaces_demo::msg::typesupport_fastrtps_cpp::_LiftControl__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_interfaces_demo, msg, LiftControl)() {
  return &base_interfaces_demo::msg::typesupport_fastrtps_cpp::_LiftControl__handle;
}
