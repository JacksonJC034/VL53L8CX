...
#include "base_interfaces_demo/msg/detail/system_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const base_interfaces_demo::msg::SystemStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<base_interfaces_demo::msg::SystemStatus *>(
    untyped_ros_message);
...
{
  return &base_interfaces_demo::msg::typesupport_fastrtps_cpp::_SystemStatus__handle;
}
