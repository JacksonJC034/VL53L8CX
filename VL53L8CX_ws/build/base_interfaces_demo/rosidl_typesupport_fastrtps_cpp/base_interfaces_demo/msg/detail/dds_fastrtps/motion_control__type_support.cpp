...
#include "base_interfaces_demo/msg/detail/motion_control__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const base_interfaces_demo::msg::MotionControl *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<base_interfaces_demo::msg::MotionControl *>(
    untyped_ros_message);
...
{
  return max_serialized_size_MotionControl(full_bounded, 0);
}
...
{
  return &base_interfaces_demo::msg::typesupport_fastrtps_cpp::_MotionControl__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_interfaces_demo, msg, MotionControl)() {
  return &base_interfaces_demo::msg::typesupport_fastrtps_cpp::_MotionControl__handle;
}
