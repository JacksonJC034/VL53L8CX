...
#include "base_interfaces_demo/msg/detail/bt_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const base_interfaces_demo::msg::BtStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  base_interfaces_demo::msg::BtStatus & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
...
{
  auto typed_message =
    static_cast<const base_interfaces_demo::msg::BtStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<base_interfaces_demo::msg::BtStatus *>(
    untyped_ros_message);
...
{
  return max_serialized_size_BtStatus(full_bounded, 0);
}
...
{
  return &base_interfaces_demo::msg::typesupport_fastrtps_cpp::_BtStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_interfaces_demo, msg, BtStatus)() {
  return &base_interfaces_demo::msg::typesupport_fastrtps_cpp::_BtStatus__handle;
}
