...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, base_interfaces_demo, action, Nav_SendGoal)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<base_interfaces_demo::action::Nav_SendGoal>();
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, base_interfaces_demo, action, Nav_GetResult)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<base_interfaces_demo::action::Nav_GetResult>();
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_action_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__ACTION_SYMBOL_NAME(rosidl_typesupport_cpp, base_interfaces_demo, action, Nav)() {
  return ::rosidl_typesupport_cpp::get_action_type_support_handle<base_interfaces_demo::action::Nav>();
}
