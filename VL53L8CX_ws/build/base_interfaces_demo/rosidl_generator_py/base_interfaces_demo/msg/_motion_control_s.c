...
bool base_interfaces_demo__msg__motion_control__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // total_odom
    PyObject * field = PyObject_GetAttrString(_pymsg, "total_odom");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->total_odom = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * base_interfaces_demo__msg__motion_control__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("base_interfaces_demo.msg._motion_control");
  ...
  {  // total_odom
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->total_odom);
    {
      int rc = PyObject_SetAttrString(_pymessage, "total_odom", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
