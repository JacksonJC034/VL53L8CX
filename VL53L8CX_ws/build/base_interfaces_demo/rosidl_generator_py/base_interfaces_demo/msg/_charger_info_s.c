...
bool base_interfaces_demo__msg__charger_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("base_interfaces_demo.msg._charger_info.ChargerInfo", full_classname_dest, 50) == 0);
  }
  base_interfaces_demo__msg__ChargerInfo * ros_message = _ros_message;
  {  // charger_status
...
PyObject * base_interfaces_demo__msg__charger_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("base_interfaces_demo.msg._charger_info");
