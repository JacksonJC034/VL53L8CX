...
base_interfaces_demo__srv__CheckEmergency_Request__create()
{
  ...
  base_interfaces_demo__srv__CheckEmergency_Request * msg = (base_interfaces_demo__srv__CheckEmergency_Request *)allocator.allocate(sizeof(base_interfaces_demo__srv__CheckEmergency_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(base_interfaces_demo__srv__CheckEmergency_Request));
  bool success = base_interfaces_demo__srv__CheckEmergency_Request__init(msg);
  if (!success) {
...
base_interfaces_demo__srv__CheckEmergency_Request__destroy(base_interfaces_demo__srv__CheckEmergency_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    base_interfaces_demo__srv__CheckEmergency_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
base_interfaces_demo__srv__CheckEmergency_Request__Sequence__init(base_interfaces_demo__srv__CheckEmergency_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  base_interfaces_demo__srv__CheckEmergency_Request * data = NULL;

  if (size) {
    data = (base_interfaces_demo__srv__CheckEmergency_Request *)allocator.zero_allocate(size, sizeof(base_interfaces_demo__srv__CheckEmergency_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = base_interfaces_demo__srv__CheckEmergency_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        base_interfaces_demo__srv__CheckEmergency_Request__fini(&data[i - 1]);
      }
...
base_interfaces_demo__srv__CheckEmergency_Request__Sequence__fini(base_interfaces_demo__srv__CheckEmergency_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      base_interfaces_demo__srv__CheckEmergency_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  base_interfaces_demo__srv__CheckEmergency_Request__Sequence * array = (base_interfaces_demo__srv__CheckEmergency_Request__Sequence *)allocator.allocate(sizeof(base_interfaces_demo__srv__CheckEmergency_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = base_interfaces_demo__srv__CheckEmergency_Request__Sequence__init(array, size);
  if (!success) {
...
base_interfaces_demo__srv__CheckEmergency_Request__Sequence__destroy(base_interfaces_demo__srv__CheckEmergency_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    base_interfaces_demo__srv__CheckEmergency_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
base_interfaces_demo__srv__CheckEmergency_Request__Sequence__are_equal(const base_interfaces_demo__srv__CheckEmergency_Request__Sequence * lhs, const base_interfaces_demo__srv__CheckEmergency_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!base_interfaces_demo__srv__CheckEmergency_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  base_interfaces_demo__srv__CheckEmergency_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(base_interfaces_demo__srv__CheckEmergency_Request);
    base_interfaces_demo__srv__CheckEmergency_Request * data =
      (base_interfaces_demo__srv__CheckEmergency_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!base_interfaces_demo__srv__CheckEmergency_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          base_interfaces_demo__srv__CheckEmergency_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!base_interfaces_demo__srv__CheckEmergency_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  base_interfaces_demo__srv__CheckEmergency_Response * msg = (base_interfaces_demo__srv__CheckEmergency_Response *)allocator.allocate(sizeof(base_interfaces_demo__srv__CheckEmergency_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(base_interfaces_demo__srv__CheckEmergency_Response));
  bool success = base_interfaces_demo__srv__CheckEmergency_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
base_interfaces_demo__srv__CheckEmergency_Response__destroy(base_interfaces_demo__srv__CheckEmergency_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    base_interfaces_demo__srv__CheckEmergency_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
base_interfaces_demo__srv__CheckEmergency_Response__Sequence__init(base_interfaces_demo__srv__CheckEmergency_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  base_interfaces_demo__srv__CheckEmergency_Response * data = NULL;

  if (size) {
    data = (base_interfaces_demo__srv__CheckEmergency_Response *)allocator.zero_allocate(size, sizeof(base_interfaces_demo__srv__CheckEmergency_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = base_interfaces_demo__srv__CheckEmergency_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        base_interfaces_demo__srv__CheckEmergency_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
base_interfaces_demo__srv__CheckEmergency_Response__Sequence__fini(base_interfaces_demo__srv__CheckEmergency_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      base_interfaces_demo__srv__CheckEmergency_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  base_interfaces_demo__srv__CheckEmergency_Response__Sequence * array = (base_interfaces_demo__srv__CheckEmergency_Response__Sequence *)allocator.allocate(sizeof(base_interfaces_demo__srv__CheckEmergency_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = base_interfaces_demo__srv__CheckEmergency_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
base_interfaces_demo__srv__CheckEmergency_Response__Sequence__destroy(base_interfaces_demo__srv__CheckEmergency_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    base_interfaces_demo__srv__CheckEmergency_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
base_interfaces_demo__srv__CheckEmergency_Response__Sequence__are_equal(const base_interfaces_demo__srv__CheckEmergency_Response__Sequence * lhs, const base_interfaces_demo__srv__CheckEmergency_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!base_interfaces_demo__srv__CheckEmergency_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  base_interfaces_demo__srv__CheckEmergency_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(base_interfaces_demo__srv__CheckEmergency_Response);
    base_interfaces_demo__srv__CheckEmergency_Response * data =
      (base_interfaces_demo__srv__CheckEmergency_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!base_interfaces_demo__srv__CheckEmergency_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          base_interfaces_demo__srv__CheckEmergency_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!base_interfaces_demo__srv__CheckEmergency_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
