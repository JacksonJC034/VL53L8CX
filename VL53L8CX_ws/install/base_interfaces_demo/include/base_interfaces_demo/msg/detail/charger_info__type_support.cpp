...
{
  new (message_memory) base_interfaces_demo::msg::ChargerInfo(_init);
}

void ChargerInfo_fini_function(void * message_memory)
{
  auto typed_message = static_cast<base_interfaces_demo::msg::ChargerInfo *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ChargerInfo_message_member_array[3] = {
  {
    ...
    offsetof(base_interfaces_demo::msg::ChargerInfo, charger_status),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(base_interfaces_demo::msg::ChargerInfo, status),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(base_interfaces_demo::msg::ChargerInfo, error_code),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ChargerInfo_message_members = {
  ...
  3,  // number of fields
  sizeof(base_interfaces_demo::msg::ChargerInfo),
...
{
  return &::base_interfaces_demo::msg::rosidl_typesupport_introspection_cpp::ChargerInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, base_interfaces_demo, msg, ChargerInfo)() {
  return &::base_interfaces_demo::msg::rosidl_typesupport_introspection_cpp::ChargerInfo_message_type_support_handle;
}
