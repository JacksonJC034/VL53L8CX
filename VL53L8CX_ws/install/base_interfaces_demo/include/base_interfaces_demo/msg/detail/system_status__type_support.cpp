...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SystemStatus_message_member_array[3] = {
  {
    ...
    offsetof(base_interfaces_demo::msg::SystemStatus, selfcheck_status),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(base_interfaces_demo::msg::SystemStatus, error_code),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
