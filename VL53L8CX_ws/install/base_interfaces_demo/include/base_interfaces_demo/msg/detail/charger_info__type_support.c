...
#include <stddef.h>
#include "base_interfaces_demo/msg/detail/charger_info__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  base_interfaces_demo__msg__ChargerInfo__init(message_memory);
}

void ChargerInfo__rosidl_typesupport_introspection_c__ChargerInfo_fini_function(void * message_memory)
{
  base_interfaces_demo__msg__ChargerInfo__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember ChargerInfo__rosidl_typesupport_introspection_c__ChargerInfo_message_member_array[3] = {
  {
    ...
    offsetof(base_interfaces_demo__msg__ChargerInfo, charger_status),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(base_interfaces_demo__msg__ChargerInfo, status),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(base_interfaces_demo__msg__ChargerInfo, error_code),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers ChargerInfo__rosidl_typesupport_introspection_c__ChargerInfo_message_members = {
  ...
  3,  // number of fields
  sizeof(base_interfaces_demo__msg__ChargerInfo),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, base_interfaces_demo, msg, ChargerInfo)() {
