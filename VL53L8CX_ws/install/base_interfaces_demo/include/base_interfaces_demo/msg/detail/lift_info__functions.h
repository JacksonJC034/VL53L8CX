...
#ifndef BASE_INTERFACES_DEMO__MSG__DETAIL__LIFT_INFO__FUNCTIONS_H_
#define BASE_INTERFACES_DEMO__MSG__DETAIL__LIFT_INFO__FUNCTIONS_H_
 ...
 * calls
 * base_interfaces_demo__msg__LiftInfo__init().
...
/**
 * It calls
 * base_interfaces_demo__msg__LiftInfo__fini()
 ...
 * base_interfaces_demo__msg__LiftInfo__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * base_interfaces_demo__msg__LiftInfo__Sequence__fini()
 * on the array,
...
#endif  // BASE_INTERFACES_DEMO__MSG__DETAIL__LIFT_INFO__FUNCTIONS_H_
