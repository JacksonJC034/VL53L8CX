...
#ifndef BASE_INTERFACES_DEMO__MSG__DETAIL__MOTOR_STATUS__FUNCTIONS_H_
#define BASE_INTERFACES_DEMO__MSG__DETAIL__MOTOR_STATUS__FUNCTIONS_H_
 ...
 * calls
 * base_interfaces_demo__msg__MotorStatus__init().
...
/**
 * It calls
 * base_interfaces_demo__msg__MotorStatus__fini()
 ...
 * base_interfaces_demo__msg__MotorStatus__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * base_interfaces_demo__msg__MotorStatus__Sequence__fini()
 * on the array,
...
#endif  // BASE_INTERFACES_DEMO__MSG__DETAIL__MOTOR_STATUS__FUNCTIONS_H_
