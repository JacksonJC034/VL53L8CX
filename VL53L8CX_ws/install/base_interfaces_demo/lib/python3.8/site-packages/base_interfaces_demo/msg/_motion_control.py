    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'base_interfaces_demo.msg.MotionControl')
            logger.debug(
...
class MotionControl(metaclass=Metaclass_MotionControl):
    ...
    def __eq__(self, other):
        ...
        if self.status != other.status:
            return False
        if self.total_odom != other.total_odom:
            return False
        return True
    ...
    @property
    def total_odom(self):
        """Message field 'total_odom'."""
        return self._total_odom

    @total_odom.setter
    def total_odom(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'total_odom' field must be of type 'float'"
        self._total_odom = value
