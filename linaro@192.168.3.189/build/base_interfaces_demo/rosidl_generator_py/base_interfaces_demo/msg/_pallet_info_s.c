...
bool base_interfaces_demo__msg__pallet_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("base_interfaces_demo.msg._pallet_info.PalletInfo", full_classname_dest, 48) == 0);
  }
  base_interfaces_demo__msg__PalletInfo * ros_message = _ros_message;
  {  // distance
...
{
  /* NOTE(esteve): Call constructor of PalletInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("base_interfaces_demo.msg._pallet_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PalletInfo");
